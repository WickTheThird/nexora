...
| 9. Brevo sender domain verified | PENDING | Add `fintrexcontractors.com` → take their 4 DKIM/SPF/DMARC records into Cloudflare DNS → wait for verify |
| 10. `EMAIL_FROM` env var flipped | PENDING | Only after Brevo verifies, e.g. `noreply@fintrexcontractors.com` |
