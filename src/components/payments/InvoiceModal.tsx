...
export function InvoiceModal({
  ...
  const download = async () => {
    ...
    try {
      ...
      // Admin-side download is always the "advice" (principal → sub).
      // The actual invoice is generated by the sub from their portal.
      downloadInvoicePdf(inv, brandName(), "advice");
  ...
  const sendToAccountant = async () => {
    ...
    window.location.href = invoiceMailto(inv, brandName(), "advice");
  };
  ...
  return (
    <Modal
      ...
      onClose={close}
      width="xl"
      title="Generate payment advice"
      description="Payment advice for any date range. Pulls all payments in the period and renders a PDF you can send to the subcontractor. They will issue the legal invoice from their portal."
      footer={
        <>
          ...
          <div className="space-y-4">
            <div className="card-padded bg-ink-50/50">
              <div className="flex items-center justify-between flex-wrap gap-3">
                <div>
                  <div className="text-xs uppercase tracking-wider text-ink-500 font-semibold">Advice ref.</div>
