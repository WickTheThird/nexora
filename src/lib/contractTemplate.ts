...
const CONTRACT_SECTIONS_EN: SectionBlock[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "6.4 The Contractor may amend these terms from time to time by publishing the amended version at fintrexcontractors.com/legal/contract; the Subcontractor's continued acceptance of payment and continued performance of the Services following publication constitutes acceptance of any such amendment. Any variation that adversely affects accrued rights of the Subcontractor in respect of Services already performed shall require the written agreement of both parties.",
